...
use nalgebra::{Matrix2, Vector2, Vector5};
use ndarray::{array, Array, ArrayView2};
use rayon::prelude::*;
...
pub fn lbfgs_test() {
    ...
    let res = Executor::new(cost, solver)
        .configure(|state| state.param(guess).max_iters(60))
        .run()
        .unwrap();
